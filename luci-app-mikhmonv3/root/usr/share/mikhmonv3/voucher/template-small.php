...
elseif($getsprice == "4000"){ $color = "#FF4500";}
elseif($getsprice == "1500"){ $color = "#E65100";}
elseif($getsprice == "5000"){ $color = "#FF1493";}
elseif($getsprice == "6000"){ $color = "#008000";}
elseif($getsprice == "25000"){ $color = "#FF00FF";}
elseif($getsprice == "50000"){ $color = "#E60C00";} 
elseif($getsprice == "150000"){ $color = "#FF0000";} 
